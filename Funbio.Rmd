...
#https://1drv.ms/u/s!AhNWk0wxoDWOh7V9X7PqrQYjCta1Vg?e=3NAn5S
...
shpUCs = readOGR("shapes\\ucstodas.shp") ### Importar Shps
...
gplot(sPESP)+
  geom_tile(aes(fill=factor(value, labels = vlabelPESP)), alpha=0.8)+
  
  scale_fill_manual(values = vPalettesPESP,
                    name= "Cobertura e uso do solo",na.translate = FALSE)+
